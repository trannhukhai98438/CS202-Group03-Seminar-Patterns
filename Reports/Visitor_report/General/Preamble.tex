% Essential for making this template work are graphicx, float, tabularx, tocbibind, titlesec, fancyhdr, xcolor and tikz.
...
\usepackage{tabularx, booktabs, multirow} % Adds additional customization for tables
