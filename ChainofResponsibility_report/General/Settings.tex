...
\newcommand{\reportname}{Chain of Responsibility}
\newcommand{\reporttitle}{Seminar: Design Patterns}

% \newcommand{\studentname}{ \\ }
\newcommand{\teachername}{%
  \makebox[4.0cm][l]{PhD. DINH Ba Tien}%
  \\
  \makebox[4.0cm][l]{MSc. TRUONG Phuoc Loc}%
  \\
  \makebox[4.0cm][l]{MSc. HO Tuan Thanh}%
}
